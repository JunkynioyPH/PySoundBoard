...
# Pre-Requisites
This is the default way of making this soundboard to work and it requires 2 things.
[https://vb-audio.com/Voicemeeter/banana.htm](VoiceMeeter Banana - For routing multiple "mic" inputs to a virtual mic output)
[https://vb-audio.com/Cable/index.htm](VB-Cable Audio Device - Virtual Cable for PySoundBoard to output audio to.)
