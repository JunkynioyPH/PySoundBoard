...
# AudioSystem.stopAll()
# AudioSystem.playAll()
# AudioSystem.unloadAudioMedia('ambient',2)
# AudioSystem.status()
# AudioSystem.unloadAllMedia(SoundType.SOUND_EFFECT)
# AudioSystem.unloadAllMedia(SoundType.MASTER_VOLUME)
# AudioSystem.unloadAllMedia(SoundType.AUDIO_MEDIA)
AudioSystem.unloadAllMedia()
